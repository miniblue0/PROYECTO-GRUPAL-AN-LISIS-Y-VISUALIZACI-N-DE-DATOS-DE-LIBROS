...
def transform_data(raw_path, transformed_path):
    ...
    try:
        ...
        for item in books:
            ...
            popularidad = item.get("volumeInfo", {}).get("averageRating")
            ...
            if popularidad_categoria is not None:
                ...
                popularidad_categoria = "Desconocida"

            if popularidad is None:
                popularidad = "Desconocida"  #si la popularidad es null la cambia por "Desconocida"
